...
% 円形カラーマップの定義（位相用）
phaseColorMap = [linspace(0,1,128)', linspace(0,0.8,128)', ones(128,1);...
                 ones(128,1), linspace(0.8,0,128)', linspace(1,0,128)'];
...
subplot(6, 3, 2);
imagesc(maxPhase, [0, 2*pi]); axis image; colormap(phaseColorMap); colorbar;
...
imagesc(grayPhase, [0, 2*pi]); axis image; colormap(phaseColorMap); colorbar;
hold on;
plot([centerX, centerX], ylim, 'r--', 'LineWidth', 1.5);
rectangle('Position', [L_start, 1, L_end - L_start + 1, frameHeight], 'EdgeColor', 'r', 'LineWidth', 1.5);
rectangle('Position', [R_start, 1, R_end - R_start + 1, frameHeight], 'EdgeColor', 'r', 'LineWidth', 1.5);
...
subplot(6, 3, 11);
imagesc(phaseDiffLR, [0, 2*pi]); axis image; colormap(phaseColorMap); colorbar;
...
imagesc(grayPhaseUD, [0, 2*pi]); axis image; colormap(phaseColorMap); colorbar;
hold on;
plot(xlim, [centerY, centerY], 'g--', 'LineWidth', 1.5);
rectangle('Position', [1, U_start, frameWidth, U_end - U_start + 1], 'EdgeColor', 'g', 'LineWidth', 1.5);
rectangle('Position', [1, D_start, frameWidth, D_end - D_start + 1], 'EdgeColor', 'g', 'LineWidth', 1.5);
...
subplot(6, 3, 17);
imagesc(phaseDiffUD, [0, 2*pi]); axis image; colormap(phaseColorMap); colorbar;
